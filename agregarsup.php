<html lang="es">
	...
	<FONT COLOR="WHITE" size="4" >
		<div class="container">
			<div class="row">
			<br><br>
				<FONT COLOR="WHITE" size="10" ><b><u><center>AGREGAR SUPERIOR</center></u></b></font>
			</div>
			<br><br>
			<form class="form-horizontal" method="POST" action="guardarsuperior.php" autocomplete="off">

				
				<div class="form-group">
					<label for="email" class="col-sm-2 control-label">Nombre del Superior *</label>
					<div class="col-sm-10">
				...
				<div class="form-group">
					<label for="Nota" class="col-sm-2 control-label">Contraseña del Superior *</label>
					<div class="col-sm-10">
