...
if($inc){
  $consulta="SELECT * FROM seccionacademica";
}
?>
<!DOCTYPE>
<html>
<head>
 <link rel='shortcut icon' href='images/favi.ico'>
  <title>VISUALIZAR SUPERIORES</title>
  <link rel='shortcut icon' href='images/favi.ico'>
...
<body style="background-image:url('e3.gif');"font color="WHITE">
  ...
  <div class="container-table">
      <div class="table__title">Superiores Registrados</div> 
      ...
      while($row=mysqli_fetch_assoc($resultado)) {
        ...
        ?>
        <br>
      <div class="table__item"><?php echo $row['Clave_Sup']; ?></div>
      <br>
      <div class="table__item"><?php echo $row['NombreSuperior']; ?></div>
